...
public class SpectorprofmCharacter extends ABCharacter {
    public SpectorprofmCharacter(float healReserve, int stars, float stamina, int strength, float staminaRegen, float healRegen, int defence, Path pathID, CharacterName name) {
        super(healReserve, stars, stamina, strength, staminaRegen, healRegen, defence, pathID, name);
    }
    public SpectorprofmCharacter() {
        super(100.0F, 0, 100.0F, 1, 0.01F, 0.01F, 10, new CreatePath(), CharacterName.SPECTORPROFM);
    }
}
